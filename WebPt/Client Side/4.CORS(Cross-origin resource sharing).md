...
```
┌─────────────┐         ┌─────────────┐         ┌─────────────┐
│   Browser   │         │  evil.com   │         │  bank.com   │
│   (You)     │         │  (Attacker) │         │  (Your Bank)│
└──────┬──────┘         └──────┬──────┘         └──────┬──────┘
       │                       │                       │
       │  Malicious JS tries:  │                       │
       ...
       │◄──────────────────────────────────────────────┤
       │                       │                       │
       │  🛡️ BROWSER BLOCKS JS FROM READING RESPONSE   │
...
```
┌─────────────────────────────────────────────────────────────────────────┐
│                        SOP PERMISSIONS MATRIX                           │
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  ✅ ALLOWED (Cross-Origin):                                             │
│  ├── Embedding images:        <img src="other-origin/pic.jpg">          │
│  ├── Embedding CSS:           <link href="other-origin/style.css">      │
│  ├── Embedding scripts:       <script src="other-origin/app.js">        │
│  ├── Embedding videos:        <video src="other-origin/video.mp4">      │
│  ├── Embedding iframes:       <iframe src="other-origin/page">          │
│  ├── Form submissions:        <form action="other-origin/submit">       │
│  └── Sending requests:        fetch() or XMLHttpRequest                 │
│                                                                         │
│  ❌ BLOCKED (Cross-Origin):                                             │
│  ├── Reading response data from fetch/XHR                               │
│  ├── Reading iframe content (DOM access)                                │
│  ├── Reading canvas with cross-origin images                            │
│  └── Accessing cookies/storage of other origins                         │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
#### **4. How to Relax SOP?**
